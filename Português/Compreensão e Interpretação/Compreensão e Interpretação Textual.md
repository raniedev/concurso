...
Decodificação objetiva do que está explícito no texto. A interpretação de textos envolve a capacidade de chegar a determinadas conclusões após fazer a leitura ou escutar um texto. Trabalha com a percepção visual, auditivo, escrito e/ou oral.

### QUESTÃO Exemplo

_Em muitos centros urbanos, o som dos pássaros foi substituído pelo ruído incessante do tráfego. O tempo desacelerado das conversas na calçada deu lugar à pressa anônima dos corredores de metrô. O cotidiano da cidade moderna parece moldado pela urgência, em que o silêncio é raro e o encontro, efêmero. Nessa lógica, perde-se o espaço para a contemplação e o afeto, elementos fundamentais para o equilíbrio humano._

O texto expressa uma visão:

- ✔ nostálgica, ao comparar o passado e o presente das cidades.
- b) científica, ao explicar os efeitos fisiológicos da poluição sonora.
...
_TCE – Sergipe – Analista T.I. – Desenv. – FGV_
...
- b) o corre-corre da vida moderna é a causa do distanciamento do espiritual e do imediatismo;
